...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[], use_mult=False,att=False,multsc=False,use_bias_anyway=0):
    ...
    if netG == 'resnet_9blocks':
        ...
        net = UnetGenerator4(input_nc, output_nc, 8, ngf, norm_layer=norm_layer, use_dropout=use_dropout, use_mult=use_mult,att=att,multsc=multsc,use_bias_anyway=use_bias_anyway)
    elif netG == 'unet_5':
        net = UnetGenerator5(input_nc, output_nc, 8, ngf, norm_layer=norm_layer, use_dropout=use_dropout, use_mult=use_mult,att=att,multsc=multsc,use_bias_anyway=use_bias_anyway)
    else:
...
class UnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, use_mult=False,att=False,multsc=False):
        ...
        for i in range(num_downs - 5):          # add intermediate layers with ngf * 8 filters
            unet_block = UnetSkipConnectionBlock(ngf * 8, ngf * 8, input_nc=None, submodule=unet_block, norm_layer=norm_layer, use_dropout=use_dropout,multsc=multsc)
        ...
        unet_block = UnetSkipConnectionBlock(ngf * 2, ngf * 4, input_nc=None, submodule=unet_block, norm_layer=norm_layer,multsc=multsc)
        unet_block = UnetSkipConnectionBlock(ngf, ngf * 2, input_nc=None, submodule=unet_block, norm_layer=norm_layer,multsc=multsc)
        self.model = UnetSkipConnectionBlock(output_nc, ngf, input_nc=input_nc, submodule=unet_block, outermost=True, norm_layer=norm_layer,tanh=(output_nc==3),multsc=multsc)  # add the outermost layer
    def forward(self, input):
        """Standard forward"""
        if(self.output_nc == 3):
...
class UnetGenerator4(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, use_mult=False,att=False,multsc=False,use_bias_anyway=0):
        ...
        self.output_nc = output_nc
        # construct unet structure
        unet_block = UnetSkipConnectionBlock4(ngf * 8, ngf * 8, input_nc=None, submodule=None, norm_layer=norm_layer, innermost=True,use_bias_anyway=use_bias_anyway,depth=3)  # add the innermost layer
        for i in range(num_downs - 5):          # add intermediate layers with ngf * 8 filters
            unet_block = UnetSkipConnectionBlock4(ngf * 8, ngf * 8, input_nc=None, submodule=unet_block, norm_layer=norm_layer, use_dropout=use_dropout,multsc=multsc,stride2=(num_downs-i)%2,use_bias_anyway=use_bias_anyway,depth=(num_downs - 2-i)//2)
        # gradually reduce the number of filters from ngf * 8 to ngf
        unet_block = UnetSkipConnectionBlock4(ngf * 4, ngf * 8, input_nc=None, submodule=unet_block, norm_layer=norm_layer, mult=use_mult,att=att,multsc=multsc,use_bias_anyway=use_bias_anyway,depth=1)#True)
        unet_block = UnetSkipConnectionBlock4(ngf * 2, ngf * 4, input_nc=None, submodule=unet_block, norm_layer=norm_layer,multsc=multsc,stride2=0,use_bias_anyway=use_bias_anyway,depth=1)
        unet_block = UnetSkipConnectionBlock4(ngf, ngf * 2, input_nc=None, submodule=unet_block, norm_layer=norm_layer,multsc=multsc,use_bias_anyway=use_bias_anyway,depth=0)
        self.model = UnetSkipConnectionBlock4(output_nc, ngf, input_nc=input_nc, submodule=unet_block, outermost=True, norm_layer=norm_layer,tanh=(output_nc==3),multsc=multsc,stride2=0,use_bias_anyway=use_bias_anyway,depth=0)
...
class UnetGenerator5(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, use_mult=False,att=False,multsc=False,use_bias_anyway=0):
        ...
        self.output_nc = output_nc
        # construct unet structure
        unet_block = UnetSkipConnectionBlock4(ngf * 8, ngf * 8, input_nc=None, submodule=None, norm_layer=norm_layer, innermost=True,use_bias_anyway=use_bias_anyway)  # add the innermost layer
        for i in range(num_downs - 5):          # add intermediate layers with ngf * 8 filters
            unet_block = UnetSkipConnectionBlock4(ngf * 8, ngf * 8, input_nc=None, submodule=unet_block, norm_layer=norm_layer, use_dropout=use_dropout,multsc=multsc,use_bias_anyway=use_bias_anyway)
        # gradually reduce the number of filters from ngf * 8 to ngf
        unet_block = UnetSkipConnectionBlock4(ngf * 4, ngf * 8, input_nc=None, submodule=unet_block, norm_layer=norm_layer, mult=use_mult,att=att,multsc=multsc,use_bias_anyway=use_bias_anyway)#True)
        unet_block = UnetSkipConnectionBlock4(ngf * 2, ngf * 4, input_nc=None, submodule=unet_block, norm_layer=norm_layer,multsc=multsc,use_bias_anyway=use_bias_anyway)
        unet_block = UnetSkipConnectionBlock4(ngf, ngf * 2, input_nc=None, submodule=unet_block, norm_layer=norm_layer,multsc=multsc,use_bias_anyway=use_bias_anyway)
        self.model = UnetSkipConnectionBlock4(output_nc, ngf, input_nc=input_nc, submodule=unet_block, outermost=True, norm_layer=norm_layer,tanh=(output_nc==3),multsc=multsc,use_bias_anyway=use_bias_anyway,stride2=0)
    ...
    def __init__(self,innc,outnc,nc,bn=0.1,dropout_rate=0,wn=0,ins_norm=0):
        ...
        for i in range(depth):
            if i==0:
                ...
                block=self.block(nc[i-1],nc[i],'down',dropout_rate=dropout_rate)
            cnn+=block
        self.cnn=nn.Sequential(*cnn)
    ...
    def __init__(self,innc,outnc,nc,bn=0.1,dropout_rate=0,wn=0,ins_norm=0):
        ...
        for i in range(depth):
            if i==0:
                ...
                block=self.block(nc[i-1],nc[i],'down',bn,dropout_rate=dropout_rate)
